    ...
    $.get(baseUrl)
        .then(response => {
            ...
            for(var i = 0; i < response.length; i++){
                ...
                var heroImg = $("<img src='' alt='' class='card-img-top img-thumbnail' id='hero_img'>");
                ...
                var fightBtn = $("<button class='btn btn-secondary fightBtn'>").text("Fight!");

                heroCard.append(heroImg);
                heroImg.attr("src", response[i].img_url).attr("alt", "Image of " + response[i].name);
